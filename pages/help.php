        ...
        <div class="card-title d-flex flex-column align-items-center card-body p-5">
            ...
            <ul class="text-left mt-5">
                ...
                <li>In the Quiz Game there are three main categories of difficulty. If you answer correctly, you will
                    see
                    a question from more difficult group of questions, if not, you will see set of easier questions.
                </li>
                ...
                <li>Depends on your answers, you will see a number of points you got. If you would like to save the
                    questions,
                    click on "Save" button. You will see a modal window where you should fill your name and click
                    "Save".
                </li>
